...
public class Audio
{
    ...
    public void List(ChoiceBox audioInBox, ChoiceBox audioOutBox, int sampleRate)
    {
        ...
        for (int i = 0; i < aInfos.length; i++)
        {
            ...
            {
                logger.info("Is a hardware port");
                ...
                for (Line.Info targetInfo : targetInfos)
                {
                    ...
                    logger.info("audio out target : " + mixer.getMixerInfo().getName() + "/" + pi.getName());
                ...
                for (Line.Info sourceInfo : sourceInfos)
                {
                    ...
                    logger.info("audio in source : " + mixer.getMixerInfo().getName() + "/" + pi.getName());
