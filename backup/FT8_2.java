...
public class FT8
{
    ...
    private double[] symbol5;
    private double[] symbol6;
    private double[] symbol7;
    ...
    public double[] makeAudio(int fSelected, double gain)
    {
        ...
        symbol0 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol1 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol2 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol3 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol4 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol5 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol6 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
        nrOfSinusesPerSymbol++;
        symbol7 = makeAudioSymbols(nrOfSinusesPerSymbol, gain, NR_OF_SAMPLES_PER_SYMBOL_FT8);
    ...
    private byte[] encode(String message)
    {
        ...
        logger.fine("FT8 at 13 chars : |" + FT8MessageFixedAt13 + "|");
        ...
        logger.fine("Source-encoded message, 77 bits : " + dumpBigInteger(bigSource77, 77));
        /* must be :
